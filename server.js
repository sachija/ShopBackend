...
mongoose.connect('mongodb+srv://poojaThorat:Sachija1305@cluster0.gpeulft.mongodb.net/test?retryWrites=true&w=majority',{ useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
